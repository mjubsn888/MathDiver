...
public class TestView {
    ...
    public static void main(String[] args) { 
        ...
        //FrameDashboard frameK1Rewards=new FrameDashboard();
        //FrameK1Rewards frameK1Rewards=new FrameK1Rewards();
        //FrameK1AdditionTest frameK1AdditionTest=new FrameK1AdditionTest("abc","k1","Addition");
        //FrameK1AdditionTest frameK1AdditionTest=new FrameK1AdditionTest("abc","k1","Addition");
    }
}
