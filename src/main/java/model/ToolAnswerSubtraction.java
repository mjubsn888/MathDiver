...
public class ToolAnswerSubtraction {
    ArrayList<Boolean> listAnswerBool;
    int nbrCorrect=0;
    int nbrTotal=0;

    public ToolAnswerSubtraction(){
        listAnswerBool=new ArrayList<>();
    }

    public ToolAnswerSubtraction(ArrayList<String> listAnswer, ArrayList<QuestionSubtraction> listQuestion){
        listAnswerBool=new ArrayList<>();
    ...
    public void buildListAnswerBool(ArrayList<String> listAnswer, ArrayList<QuestionSubtraction> listQuestion) {
        boolean b;
