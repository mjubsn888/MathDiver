 ...
 * @author mju
 */
public class FrameK1Tutorial extends JFrame {    
    ...
    public FrameK1Tutorial(String userName, String level, String subject) { 
        ...
        jButtonTutorial1.setText("Addition");
        jButtonTutorial2.setText("Subtraction");
        jButtonTutorial3.setText("Countting");

        //load image
        try {
            toolImage = new ToolImage();
            for (ImageReference imageRef : toolImage.getListImageReference()) {
                if (imageRef.getImageName().equals("background-tutorial-k1-1280x720.png")) {
        ...
        jButtonTutorial1.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
            try {
            String urlMult = "https://www.youtube.com/watch?v=mjlsSYLLOS";
        ...
        jButtonTutorial2.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
            try {
            String urlMult = "https://www.youtube.com/watch?v=qM7B2nwpV1M";        
            java.awt.Desktop.getDesktop().browse(java.net.URI.create(urlMult));
        ...
        jButtonTutorial3.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
            try {
            String urlMult = "https://www.youtube.com/watch?v=ZJEIKkPXirg";        
            java.awt.Desktop.getDesktop().browse(java.net.URI.create(urlMult));
