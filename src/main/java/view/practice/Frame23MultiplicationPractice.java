 ...
 * @author mju
 */
public class Frame23MultiplicationPractice extends JFrame {
    ...
    public Frame23MultiplicationPractice(String userName, String level, String subject) {
        //1.GUI components                
        initComponents();
    ...
    public void refreshControls(){
        QuestionMultiplication q=new QuestionMultiplication();
