 ...
 * @author mju
 */
public class Frame23DivisionPractice extends JFrame {
    ...
    public Frame23DivisionPractice(String userName, String level, String subject) {
        //1.GUI components                
        initComponents();
    ...
    public void refreshControls(){
        QuestionDivision q=new QuestionDivision();
        answerCorrectIdx=q.getAnswerCorrect().getIdx();
        jLabelQuestion1.setText(q.getListParamsStr().get(2));
        jLabelQuestion2.setText(q.getListParamsStr().get(1));
