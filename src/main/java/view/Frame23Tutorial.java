 ...
 * @author mju
 */
public class Frame23Tutorial extends JFrame {    
    ...
    public Frame23Tutorial(String userName, String level, String subject) { 
        ...
        jButtonTutorial1.setText("Multiplication");
        jButtonTutorial2.setText("Division");
        jButtonTutorial3.setText("Sequence");

        //load image
        try {
            toolImage = new ToolImage();
            for (ImageReference imageRef : toolImage.getListImageReference()) {
                if (imageRef.getImageName().equals("background-tutorial-23-1280x720.png")) {
        ...
        jButtonTutorial1.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
            try {
            String urlMult = "https://www.youtube.com/watch?v=eW2dRLyoyds";
        ...
        jButtonTutorial2.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
            try {
            String urlMult = "https://www.youtube.com/watch?v=rGMecZ_aERo";        
            java.awt.Desktop.getDesktop().browse(java.net.URI.create(urlMult));
        ...
        jButtonTutorial3.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
            try {
            String urlMult = "https://www.youtube.com/watch?v=Tj89FA-d0f8";        
            java.awt.Desktop.getDesktop().browse(java.net.URI.create(urlMult));
