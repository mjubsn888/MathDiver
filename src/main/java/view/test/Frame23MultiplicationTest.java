 ...
 * @author mju
 */
public class Frame23MultiplicationTest extends JFrame {
    String userName;
    String subject;
    String level;
    ...
    TestMath testMath;
    ArrayList<QuestionMultiplication> listQuestion;
    ArrayList<String> listAnswer;

    QuestionMultiplication q;
    ToolAnswerMultiplication toolAnswerMultiplication;
    ...
    public Frame23MultiplicationTest(String userName, String level, String subject) {
        //1.GUI components                
        initComponents();
        ...
        for (int i = 0; i < nbrOfQuestions; i++) {
            listQuestion.add(new QuestionMultiplication());
            listAnswer.add("U");
        }
        ...
        jButtonSubmit.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(option==JOptionPane.YES_OPTION){
                    toolAnswerMultiplication=new ToolAnswerMultiplication(listAnswer, listQuestion);
                    try {
                        Test.resetTest(userName,test_id);
                        Test.updateTest(userName, test_id, toolAnswerMultiplication.getNbrCorrect(), toolAnswerMultiplication.getNbrTotal());
                    ...
                    strCountCompleted=Integer.toString(toolAnswerMultiplication.getNbrCorrect())+" correct out of "+Integer.toString(nbrOfQuestions);
