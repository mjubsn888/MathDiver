 ...
 * @author mju
 */
public class FrameK1AdditionTest extends JFrame {
    String userName;
    String subject;
    String level;
    ...
    TestMath testMath;
    ArrayList<QuestionAddition> listQuestion;
    ArrayList<String> listAnswer;

    QuestionAddition q;
    ToolAnswerAddition toolAnswerAddition;
    ...
    public FrameK1AdditionTest(String userName, String level, String subject) {
        //1.GUI components                
        initComponents();
        ...
        jButtonSubmit.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(option==JOptionPane.YES_OPTION){
                    toolAnswerAddition=new ToolAnswerAddition(listAnswer, listQuestion);
                    try {
                        Test.resetTest(userName,test_id);
                        Test.updateTest(userName, test_id, toolAnswerAddition.getNbrCorrect(), toolAnswerAddition.getNbrTotal());
                    ...
                    strCountCompleted=Integer.toString(toolAnswerAddition.getNbrCorrect())+" correct out of "+Integer.toString(nbrOfQuestions);
