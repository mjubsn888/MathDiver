 ...
 * @author mju
 */
public class FrameK1SubtractionTest extends JFrame {
    String userName;
    String subject;
    String level;
    ...
    TestMath testMath;
    ArrayList<QuestionSubtraction> listQuestion;
    ArrayList<String> listAnswer;

    QuestionSubtraction q;
    ToolAnswerSubtraction toolAnswerSubtraction;
    ...
    public FrameK1SubtractionTest(String userName, String level, String subject) {
        //1.GUI components                
        initComponents();
        ...
        for (int i = 0; i < nbrOfQuestions; i++) {
            listQuestion.add(new QuestionSubtraction());
            listAnswer.add("U");
        }
        ...
        jButtonSubmit.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(option==JOptionPane.YES_OPTION){
                    toolAnswerSubtraction=new ToolAnswerSubtraction(listAnswer, listQuestion);
                    try {
                        Test.resetTest(userName,test_id);
                        Test.updateTest(userName, test_id, toolAnswerSubtraction.getNbrCorrect(), toolAnswerSubtraction.getNbrTotal());
                    ...
                    strCountCompleted=Integer.toString(toolAnswerSubtraction.getNbrCorrect())+" correct out of "+Integer.toString(nbrOfQuestions);
